...
2. Open the folder for the specific Mission you want to test.
3. Double-click the `index.html` file to run the program in any web browser (Chrome, Safari, Firefox, etc.).
4. Open the `.html` and `.js` files in your code editor (like VS Code or Notepad) to explore the logic and complete the Student Challenges!
